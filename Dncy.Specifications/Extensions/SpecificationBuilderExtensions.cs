...
namespace Dncy.Specifications.Extensions
{
    ...
    public static class SpecificationBuilderExtensions
    {
            ...
            Expression<Func<T, object>> orderExpression)
        {
            ...
            OrderedSpecificationBuilder<T> orderedSpecificationBuilder =
                new OrderedSpecificationBuilder<T>(specificationBuilder.Specification);
            ...
            Expression<Func<T, TProperty>> includeExpression) where T : class
        {
            ...
            IncludableSpecificationBuilder<T, TProperty> includeBuilder =
                new IncludableSpecificationBuilder<T, TProperty>(specificationBuilder.Specification);
            ...
            string specificationName, params object[] args) where T : class
        {
            ...
            CacheSpecificationBuilder<T> cacheBuilder =
                new CacheSpecificationBuilder<T>(specificationBuilder.Specification);
